...
(* As explained more thoroughly in iris!539, Coq can run into trouble when
  ...
  problem with canonical structure inference. *)
...
(* As explained more thoroughly in iris!539, Coq can run into trouble when
  ...
  problem with canonical structure inference. *)
Global Strategy expand [ucmra_cmraR ucmra_equiv ucmra_dist ucmra_pcore ucmra_op
                        ucmra_valid ucmra_validN ucmra_ofe_mixin ucmra_cmra_mixin].
